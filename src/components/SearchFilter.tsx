...
export default function SearchFilter({children}: Props) {
    ...
    return (
        ...
        >
            <div
                className="md:border-r md:border-b-0 border-b border-gray-700 p-4 md:space-y-4 md:block flex space-x-8 md:space-x-0 sticky top-0 md:h-screen z-10 bg-white">
                <div>
                    <p className="font-semibold">Price</p>
                    <div>
                        <div>
                            <Radio placeholder="" crossOrigin
                                   name="type"
                                   label="Low to heigh"
